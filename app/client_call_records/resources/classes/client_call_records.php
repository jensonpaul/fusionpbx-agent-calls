...
/**
 * client_call_records class provides methods for adding client call records to the database
 *
 * @method boolean add
 */
if (!class_exists('client_call_records')) {
	class client_call_records {
		...
		public function __construct() {
			...
			//assign private variables (for delete method)
				$this->app_name = 'client_call_records';
				$this->app_uuid = 'f5273585-5399-4c4c-9fd0-db155327ad35';
				$this->permission_prefix = 'client_call_record_';
				$this->list_page = 'client_call_records.php';
				$this->table = 'client_call_records';
				$this->uuid_prefix = 'client_call_record_';
		}
